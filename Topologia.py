    ...
    def __init__(self):
        ...
        self.caminhos['9'] = [[self.node_interfaces['10'][-1], self.node_interfaces['16'][-1]],
                                [self.node_interfaces['6'][-1], self.node_interfaces['8'][-1], self.node_interfaces['7'][-1], self.node_interfaces['4'][-1],
                                    self.node_interfaces['12'][-1]],
                                [self.node_interfaces['5'][-1], self.node_interfaces['4'][-1], self.node_interfaces['11'][-1], self.node_interfaces['13'][-1]]]

        self.caminhos['6'] = [[self.node_interfaces['8'][-1], self.node_interfaces['10'][-1], self.node_interfaces['16'][-1]],
        ...
        self.caminhos['7'] =  [[self.node_interfaces['8'][-1], self.node_interfaces['6'][-1], self.node_interfaces['10'][-1], self.node_interfaces['9'][-1], self.node_interfaces['16'][-1]],
                                [self.node_interfaces['6'][-1], self.node_interfaces['9'][-1], self.node_interfaces['10'][-1], self.node_interfaces['16'][-1]],
                                [self.node_interfaces['4'][-1], self.node_interfaces['5'][-1], self.node_interfaces['11'][-1]],
                                [self.node_interfaces['12'][-1], self.node_interfaces['13'][-1]]]

        self.caminhos['4'] =  [[self.node_interfaces['5'][-1], self.node_interfaces['9'][-1], self.node_interfaces['6'][-1], self.node_interfaces['10'][-1],
                                    self.node_interfaces['16'][-1]],
                                [self.node_interfaces['7'][-1], self.node_interfaces['8'][-1], self.node_interfaces['6'][-1], self.node_interfaces['10'][-1],
                                    self.node_interfaces['16'][-1]],
                                [self.node_interfaces['11'][-1]],
                                [self.node_interfaces['13'][-1], self.node_interfaces['12'][-1]]]

        self.caminhos['16'] =  [[self.node_interfaces['10'][-1], self.node_interfaces['9'][-1], self.node_interfaces['8'][-1],
                                self.node_interfaces['6'][-1], self.node_interfaces['5'][-1], self.node_interfaces['7'][-1],
